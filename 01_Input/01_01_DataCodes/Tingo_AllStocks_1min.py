...
# StockAll = pd.read_excel(r'C:\Data\Tiingo_Stock_1min\ErrorTicker.xlsx')
...
# for iTicker in range(4583,len(StockTickers)):    
    ...
    try:
        try:
            Current = pd.read_excel("./Tiingo_Stock_1min/" + Ticker + "_1min.xlsx")
        ...
        NewData.to_excel("./Tiingo_Stock_1min/" + Ticker + "_1min.xlsx",index=False)
...
pd.Series(ErrorTicker).to_excel("./Tiingo_Stock_1min/" + "ErrorTicker_1min.xlsx", index=False)

pd.Series(iTicker).to_excel("./Tiingo_Stock_1min/" + "iTicker_1min.xlsx", index=False)
