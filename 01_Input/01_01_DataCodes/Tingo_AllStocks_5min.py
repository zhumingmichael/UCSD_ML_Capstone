...
# for iTicker in range(4583,len(StockTickers)):    
    ...
    try:
        try:
            Current = pd.read_excel("./Tiingo_Stock_5min/" + Ticker + "_5min.xlsx")
        ...
        NewData.to_excel("./Tiingo_Stock_5min/" + Ticker + "_5min.xlsx",index=False)
...
pd.Series(ErrorTicker).to_excel("./Tiingo_Stock_5min/" + "ErrorTicker_5min.xlsx", index=False)

pd.Series(iTicker).to_excel("./Tiingo_Stock_5min/" + "iTicker_5min.xlsx", index=False)
